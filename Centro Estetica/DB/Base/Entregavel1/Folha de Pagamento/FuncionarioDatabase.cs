...
namespace Centro_Estetica.DB.Base.Entregavel1.Folha_de_Pagamento
{
    class FolhaPagamentoDatabase
    {
        ...
        public List<VVwConsultarFolhapagamento
            > Consultarmes(string mes)
        {
            ...
            List<VVwConsultarFolhapagamento> folhas = new List<VVwConsultarFolhapagamento>();
            while (reader.Read())
            {
                VVwConsultarFolhapagamento dto = new VVwConsultarFolhapagamento();
